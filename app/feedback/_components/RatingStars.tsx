// app/feedback/_components/RatingStars.tsx
...
type RatingStarsProps = {
  value: number | string; // ✅ Принимаем и число, и строку
...
export function RatingStars({
  ...
  // ✅ КОНВЕРТИРУЕМ value в число сразу
  ...
  // ✅ Используем numericValue вместо value
    ...
    <div className="flex items-center gap-2">
        ...
        {[1, 2, 3, 4, 5].map((starIndex) => {
          ...
          return (
            <button
              ...
              role="radio"
              aria-checked={Math.floor(numericValue) === starIndex}
            >
              <Star
                className={cn(
                  sizeMap[size],
                  'text-gray-300 fill-none transition-colors'
                )}
              />
      ...
      {showNumber && (
        <span className="text-sm font-medium text-gray-600 dark:text-gray-400">
          {/* ✅ Используем numericValue вместо displayRating */}
